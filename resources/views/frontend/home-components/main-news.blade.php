                                            ...
                                            <div class="card__post__content  ">
                                                ...
                                                <div class="card__post__title">
                                                    ...
                                                    <p class="d-none d-lg-block d-xl-block mb-0">
                                                        {!! truncate($sectionFourNews->details, 100) !!}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if ($loop->index === 0)
                                        <div class="article__entry">
                                            ...
                                            <div class="article__content">
                                                ...
                                                <p>
                                                    {!! truncate($mostViewedNews->details,100) !!}
                                                </p>
                                                <a href="{{ route('news-details', $mostViewedNews->slug) }}" class="btn btn-outline-primary mb-4 text-capitalize"> {{ __('read more')}}</a>
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
